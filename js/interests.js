...
(function () {
  /**
   * Turns DOM elements lists into actual arrays.
   * @param {object} dom_list - DOM elements list object return by DOM query
   * @return {array} arr - Actual DOM elements array
   */
